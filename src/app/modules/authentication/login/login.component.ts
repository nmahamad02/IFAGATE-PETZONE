  ...
  onSignin() {
    ...
    if (this.signinForm.invalid) {
      ...
      this.authenticationService.checkUser(data.username).subscribe ((res: any) => {
        ...
        this.authenticationService.signin(res.recordset[0].USERCODE, res.recordset[0].FIRSTNAME, res.recordset[0].LASTNAME, res.recordset[0].USERID, res.recordset[0].SPECIAL_ADMIN_RIGHTS, res.recordset[0].DEPT_ID).subscribe((res: any) => {
